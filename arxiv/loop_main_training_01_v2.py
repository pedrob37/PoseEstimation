...
#pwd = os.getcwd()
pwd = '/nfs/home/ctangwiriyasakul/DGXwork/projects/2021/202110_Oct/week02/20211014_3DposeEST3D_MCA'
...
tmp_catch = '/nfs/home/ctangwiriyasakul/DGXwork/datasets/catch/MCA_20211014_catch_training'
...
# Loading data
#sel_heatmaps = [1, 3, 5, 7, 8]
sel_heatmaps = np.linspace(28,40,13)
#sel_pafs = np.linspace(1,47,47)

d = {}
for i in range(len(sel_heatmaps)):
    idx = int(sel_heatmaps[i])
    #print(idx)
    #d["train_heatmap{00}".format(idx)] = "Hello"
    #d["train_heatmap{00}".format(idx)] = os.path.join(train_root_heatmaps, heatmaps_suffix, 'post3D', 'SABRE_*_heatmap_28.nii.gz')
    d["train_heatmap{00}".format(idx)] = glob.glob(os.path.join(train_root_heatmaps))
    #d["train_heatmap{00}".format(idx)] = sorted(glob.glob(os.path.join(train_root_heatmaps, heatmaps_suffix, 'post3D', 'SABRE_*.nii.gz')))
    del idx

# e = {}
# for x in range(1, 20):
#     e["train_heatmap{00}".format(x)] = "Hello"

print('chinchin')
# train_images = sorted(glob.glob(os.path.join(train_root_images, images_suffix, 'post3D', 'SABRE_*_img.nii.gz')))
...
# opt.criterionPaf = 'l1'
#
# models, criterion_hm, criterion_paf = create_model(opt, para)
...
#
# TT = trainTT(pwd, save_fold, train_loader, para, models, optimizer, criterion_hm, criterion_paf, val_interval) #, models, optimizer_backbone)
# TT.train()
