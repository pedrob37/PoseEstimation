...
#tmp_catch = '/home/chayanin/PycharmProjects/2020_v04_vrienv002/catch/20211014_catch_inferring'
tmp_catch = '/nfs/home/ctangwiriyasakul/DGXwork/datasets/catch/20211014_catch_inferring'
n_joints = 13
n_paf = 11
n_stages = 7
n_vector_field = 3
...
# Loading data
val_images = sorted(glob.glob(os.path.join(val_root_images, images_suffix, 'post3D', 'SABRE_*_img.nii.gz')))
...
#previous_model = pwd + '/res_20210930/PostEst_model_901.pt'
previous_model = pwd + '/res_20210931_LS/PostEst_model_901.pt'
...
II = inferII(pwd, save_fold, val_loader, para, model_use, roi_size, val_files) # models, optimizer_backbone)
II.infer()
