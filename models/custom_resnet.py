...
def get_conv1(conv1_t_size: int, conv1_t_stride: int):
    return (
        ...
        [0, conv1_t_stride, (conv1_t_stride, 2), (conv1_t_stride, 1, 1)],  # (conv1_t_stride, 2, 2)
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer2 = self._make_layer(block, block_inplanes[1], layers[1], spatial_dims, shortcut_type, stride=1)  # 2
        if len(layers) >= 3:
            self.layer3 = self._make_layer(block, block_inplanes[2], layers[2], spatial_dims, shortcut_type, stride=1)  # 2
        if len(layers) == 4:
            self.layer4 = self._make_layer(block, block_inplanes[3], layers[3], spatial_dims, shortcut_type, stride=1)  # 2
...
def resnet18(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    """
    return _resnet("resnet18", ResNetBlock, [2, 2, 2, 1], get_inplanes(), pretrained, progress, **kwargs)
...
def resnet34(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet34", ResNetBlock, [3, 4, 6, 1], get_inplanes(), pretrained, progress, **kwargs)
...
def resnet50(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet50", ResNetBottleneck, [3, 4], get_inplanes(), pretrained, progress, **kwargs)
